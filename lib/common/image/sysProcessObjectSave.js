...
proto.sysProcessObjectSave = async function sysProcessObjectSave(sourceObject, targetObject, process, targetBucket) {
  ...
  const content = {
    'x-oss-async-process': `${process}|sys/saveas,o_${targetObject}${bucketParam}`
  };
